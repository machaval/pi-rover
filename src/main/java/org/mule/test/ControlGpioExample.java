package org.mule.test;// START SNIPPET: control-gpio-snippet
...
public class ControlGpioExample
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        System.out.println("Type your command : 'left','back','right','go','stop','bye','distance");
        ...
        while (true)
        {
            ...
            {
                System.out.println("Invalid command '" + s + "' use : 'left','back','right','go','stop','bye'");
            }
        }
